...
export const article = {
  author: 'Adam Wathan',
  date: '2024-09-05',
  title: 'Los Beneficios del Jiu-Jitsu Brasileño para la Salud Mental y Física',
  description:
    'Explora cómo el BJJ puede mejorar tu bienestar general, desde la reducción del estrés hasta el aumento de la resistencia y la flexibilidad. Incluye testimonios de miembros de tu academia y estudios científicos que respalden estos beneficios.',
}
