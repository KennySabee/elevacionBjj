...
export const article = {
  author: 'Adam Wathan',
  date: '2024-07-14',
  title: 'La Historia del Jiu-Jitsu Brasileño: De Japón a Brasil y Más Allá',
  description:
    'Un artículo que narra la fascinante historia del BJJ, desde sus raíces en el Jiu-Jitsu japonés hasta su desarrollo en Brasil y su expansión global. Añade anécdotas interesantes y menciona figuras clave que han influido en el arte.',
}
