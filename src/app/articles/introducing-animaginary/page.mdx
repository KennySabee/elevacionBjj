...
export const article = {
  author: 'Adam Wathan',
  date: '2024-08-02',
  title: 'Técnicas Básicas de Defensa Personal en Jiu-Jitsu Brasileño',
  description:
    'Una guía detallada sobre algunas de las técnicas básicas de defensa personal que enseñas en tu academia. Incluye imágenes o ilustraciones paso a paso para ayudar a los lectores a comprender y practicar estas técnicas.',
}
